...
set_run_dir('../models/lightgcn/ml-1m')
...
train_events = spark.read.parquet(f'/home/jovyan/.art/cache/datasets/movielens/1m/last_one_out/train_events.parquet')
validation_gt = spark.read.parquet(f'/home/jovyan/.art/cache/datasets/movielens/1m/last_one_out/validation_ground_truth.parquet')
test_gt = spark.read.parquet(f'/home/jovyan/.art/cache/datasets/movielens/1m/last_one_out/test_ground_truth.parquet')
test_events = spark.read.parquet(f'/home/jovyan/.art/cache/datasets/movielens/1m/last_one_out/test_events.parquet')
validation_events = spark.read.parquet(f'/home/jovyan/.art/cache/datasets/movielens/1m/last_one_out/validation_events.parquet')
...
class LightGCN(MessagePassing):
    ...
    def __init__(self, num_users, num_items, embedding_dim=8, K=3, add_self_loops=False):
...
plt.ylabel('loss')
plt.title('LightGCN train & val loss curves')
plt.legend()
